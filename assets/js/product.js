/* ZNAKOMY production module loader — Core 4.4 audited */
(()=>{
  ...
  /* The old standalone review button survived an id rename and became a dead control. */
  ...
  const b='20260820-1125-site-audit';
